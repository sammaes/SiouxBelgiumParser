...
retrieved_next_general_event, next_general_event = parser.get_next_event(filter_event, filter_date)
...
print "---"
if retrieved_next_general_event:
    print "The next event is: | %s" % menu_section_title
    print "%s | %s" % (next_general_event['title'], menu_title)
    print "     %s | %s" % (datetime.strptime(next_general_event['date'], "%d/%m/%Y").strftime("%d %B %Y"), menu_details)
    print "     %s | %s" % (next_general_event['location'], menu_details)
    print "     %s | %s" % (next_general_event['category'], menu_details)
if False:
    print "---"
    print "Todo"
print "---"
